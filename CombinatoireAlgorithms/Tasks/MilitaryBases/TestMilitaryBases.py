import numpy as np
from CombinatoireAlgorithms.Tasks.MilitaryBases.MilitaryBases import GetInfoAboutBastMilitaryBase
...
print("\nCлучай, когда размерность(n) не совпадает с колличеством векторов матрицы(A)")
size = 3
A = np.array([
    [1, 1, 0, 1, 0, 0, 0, 0, 0],
    [1, 1, 1, 0, 1, 0, 0, 0, 0],
...
print("\nCлучай, когда размерность(n) не совпадает с размерностью вектора потерь(ci)")
size = 9
A = np.array([
    [1, 1, 0, 1, 0, 0, 0, 0, 0],
    [1, 1, 1, 0, 1, 0, 0, 0, 0],
...
print("\nCлучай, когда размерность(n) не совпадает с размерностью какого-либо вектора матрицы(A)")
error = False
size = 9
try:
    A = np.array([
